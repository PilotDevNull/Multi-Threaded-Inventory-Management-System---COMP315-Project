...
void AnalyticsManager::exportGlobalAnalyticsCSV() const {
    std::string basePath = "Analytics/Global/";
...
void AnalyticsManager::exportWarehouseAnalyticsCSV(int warehouseID) const {
    std::string basePath =
        "Analytics/Warehouses/Warehouse " + std::to_string(warehouseID) + "/";

    std::ofstream itemsFile(
        basePath + "Warehouse" + std::to_string(warehouseID) + "ItemRecords.csv"
    );
