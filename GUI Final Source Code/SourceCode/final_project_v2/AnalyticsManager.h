...
public:
    ...
    //    EXPORT FUNCTIONS
    // -------------------------
    // basePath must end with a directory separator. Directories are created if absent.
    void exportGlobalAnalyticsCSV(const std::string& basePath = "Analytics/Global/") const;
    void exportWarehouseAnalyticsCSV(int warehouseID, const std::string& basePath = "Analytics/Warehouses/") const;
};
